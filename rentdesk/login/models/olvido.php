...
//$rut_empresa = formatea_rut($rut_empresa);
	...
	if ($json->status == 'OK'){
		...
		$mensaje 	= "<strong>Estimado(a) <br>$json->nombreUsuario,</strong><br><br>Se ha solicitado la recuperación de su contraseña. Para obtener una contraseña haga click en el siguiente enlace y siga las instrucciones:<br><a href='$url_base/forgot.php?t=$json->token'>haga click aquí para ir a recuperar contraseña</a> <br> <br><strong>$config->sitename</strong><br>*Este email se ha generado de manera automática. No responder.";
		$nivel		= "2";
		$logo 		= "logo_email.png";
