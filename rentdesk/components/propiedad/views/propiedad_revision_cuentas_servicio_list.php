    ...
    <div>
        ...
        <div style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb d-flex align-items-center m-0">
                ...
                <li class="breadcrumb-item active" style="font-weight:600;color: #e62238" aria-current="page">Revisión Cuentas de Servicio</li>
            </ol>
        </div>
    </div>
        ...
        <div class="card-body ">
            <div style="flex-flow: wrap;gap: 0.5rem;justify-content:space-between;align-items:center" class="d-flex mb-4">
                <button type="button" class="btn btn-default btn-outline-primary btn-sm pull-right m-0" style="padding: .5rem;white-space: nowrap;" title="Ingresar Descuento">
                    <span>Descargar Cuentas de Servicios</span>
                </button>
                ...
                <button type="button" class="btn btn-danger btn-sm pull-right m-0" style="padding: .5rem;white-space: nowrap;" title="Ingresar Descuento">
                    <span>Eliminar Moras</span>
                </button> -->

                <button type="button" class="btn btn-info btn-sm recargar ms-auto" onClick="document.location.reload();">
                    <span class="glyphicon glyphicon-refresh"></span> Recargar Datos
                </button>
            </div>
            <div class="table-responsive overflow-auto">
                <table id="propiedad-rev-cuentas-servicio-table" class="table table-light" cellspacing="0" width="100%">

                    <thead>
                        <tr>
                            <th class="col-2">ID</th>
                            <th class="col-2">Ficha Técnica</th>
                            <th class="col-2">Propiedad</th>
                            <th class="col-1">Cuenta</th>
                            <th class="col-1">Monto Adeudado</th>
			...
			<div class="modal fade" id="modalDetalleServicio" tabindex="-1" aria-labelledby="modalDetalleServicioLabel" aria-hidden="true" data-bs-backdrop="static">
				<div class="modal-dialog" style="max-width: 800px;">
			      <div class="modal-content">
				    <div class="modal-header">
				    	<h5 class="modal-title" id="modalDetalleServicioLabel">Detalle cuenta</h5>
						...
						<div class="card">
                    	    <div class="card-body">
                    	    	<div class="table-responsive overflow-auto">
                    	    		...
                    	    		<table id="detalleCuenta" class="table table-striped" cellspacing="0" width="100%">
                    	    			<thead>
                    	    				<tr>
												<th>Cuenta</th>
												<th>Monto</th>
