...
<div id="header" class="header-page">
	...
	<div style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
		<ol class="breadcrumb d-flex align-items-center m-0">
			...
			<li class="breadcrumb-item active" style="font-weight:600;color: #e62238" aria-current="page">Propiedad <?php echo "#" . $ficha_tecnica; ?> <span id="direccionFichaPropiedad" style="color:rgb(106, 106, 106)"></span></li>
