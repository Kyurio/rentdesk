	...
	<div class="content content-page">
			...
			<div class="col-lg-12">
				...
				<div class="tab-content">
											...
											<div class="row g-3">
												<fieldset class="form-group border p-3">
													...
													<fieldset class="form-group border p-3" id="section-info-cta-bancaria" style="display: none">
														...
														<div class="row">
															<div class="col"><label>Nombre Titular</label><br><label id="ctaBancNombreTitularDeCuenta"></label></div>
							...
							<div class="card">
								<div class="card-body">
									...
									<div style="flex-flow: wrap;gap: 0.5rem" class="d-flex mb-4">
										...
										<button type="button" id="btnLiquidar" class="btn btn-info m-0" style="padding: .5rem;white-space: nowrap; <?php echo $mostrarboton; ?>" title="Liquidar" data-bs-toggle="modal" data-bs-target="#modalLiqCoPropsLiquidar">
											<span>Liquidar</span>
										</button>


										<div id="infoPropiedad" class="alert alert-warning" style="color:#313131; width: 100% !important; <?php echo $mostrarAlerta; ?>" role="alert">
											<strong>Estimado usuario :</strong> Para proceder con la liquidación, es necesario que existan movimientos pendientes de liquidar	.
										</div>
					...
					<div class="tab-pane" id="roles" role="tabpanel" aria-labelledby="propiedad-ft-roles-tab" tabindex="0">
						...
						<div class="modal fade" id="modalRolIngreso" data-bs-backdrop="static"  tabindex="-1" aria-labelledby="modalRolIngresoLabel" aria-hidden="true">
										...
										<form action="post">
											...
											<div class="row">
												<div class="col-md mb-3">
													...
													<input type="text" class="form-control" id="modalRolNumero" placeholder="Ingrese Número">
												</div>
											</div>
											...
											<div class="row">
												...
												<label class="switch ms-3 my-2">
													<input value="false" type="checkbox" class="" id="modalRolPrincipal" name="modalRolPrincipal" onclick="">
						...
						<div class="modal fade" id="modalRolEditar" data-bs-backdrop="static"  tabindex="-1" aria-labelledby="modalRolEditarLabel" aria-hidden="true">
							<div class="modal-dialog">
								<div class="modal-content">
									<div class="modal-header">
						...
						<!-- Modal agregar valor  -->
						<div class="modal modal-lg fade" data-bs-backdrop="static"  id="ModalAgregarValor" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
							<div class="modal-dialog">
								<div class="modal-content">
									<div class="modal-header">
						...
						<!-- Modal editar valor -->
						<div class="modal modal-lg fade" id="ModalEditarValor" data-bs-backdrop="static"  tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" style="z-index: 1050;">
							<div class="modal-dialog">
								<div class="modal-content">
									<div class="modal-header">
						...
						<!-- Modal detalle -->
						<div class="modal modal-xl fade" id="ModalDetalle" data-bs-backdrop="static"  tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
							<div class="modal-dialog">
								<div class="modal-content">
									<div class="modal-header">
		...
		<div class="modal fade" id="modalCuentaCorrienteIngresoDescuento" data-bs-backdrop="static"   tabindex="-1" aria-labelledby="modalCuentaCorrienteIngresoDescuentoLabel" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
		...
		<div class="modal fade" id="modalCuentaCorrienteIngresoAbono" data-bs-backdrop="static"  tabindex="-1" aria-labelledby="modalCuentaCorrienteIngresoAbonoLabel" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
		...
		<div class="modal fade" id="modalCuentaServiciosFijarEstado" data-bs-backdrop="static"  tabindex="-1" aria-labelledby="modalCuentaServiciosFijarEstadoLabel" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
		...
		<!-- Modal Liquidaciones CO-Propietarios - Liquidar-->
		<div class="modal fade" id="modalLiqCoPropsLiquidar"  data-bs-backdrop="static"  tabindex="-1" aria-labelledby="modalLiqCoPropsLiquidarLabel" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="modalLiqCoPropsLiquidarLabel">Liquidación</h5>
		...
		<div class="modal fade" id="modalRecordatoriosNuevo" data-bs-backdrop="static"  tabindex="-1" aria-labelledby="modalRecordatoriosNuevoLabel" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
		...
		<div class="modal fade" id="modalBeneficiarioIngreso" data-bs-backdrop="static"  tabindex="-1" aria-labelledby="modalBeneficiarioIngresoLabel"  data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel"  aria-hidden="true">
		...
		<div class="modal fade" id="modalCuentaCorrienteIngresoPagoNoLiquidable" data-bs-backdrop="static"  tabindex="-1" aria-labelledby="modalCuentaCorrienteIngresoPagoNoLiquidableLabel" aria-hidden="true">
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					<div class="modal-header">
					...
					<div class="modal-body">
						<form id="cc_pago_no_liquidable" name="cc_pago_no_liquidable" method="post" enctype="multipart/form-data">
							...
							<!-- <div>
								<button type="button" class="btn btn-info m-0" style="padding: .5rem;white-space: nowrap;" title="Agregar Documento" data-bs-toggle="modal" data-bs-target="#modalDocumentoIngresoCCPagoNL">
									<span>Agregar Documento</span>
								</button>
								<div class="card">
									<div class="card-body">
		...
		<div class="modal fade" id="modalCuentaCorrienteIngresoDescuentoAutorizado" data-bs-backdrop="static"  tabindex="-1" aria-labelledby="modalCuentaCorrienteIngresoDescuentoAutorizadoLabel" aria-hidden="true">
			<div class="modal-dialog  modal-lg">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="modalCuentaCorrienteIngresoDescuentoAutorizadoLabel">Ingresar Descuento</h5>
						<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
					</div>
					<div class="modal-body">
		...
		<div class="modal fade" id="modalInfoComentarioIngreso" data-bs-backdrop="static"  tabindex="-1" aria-labelledby="modalInfoComentarioIngresoLabel" aria-hidden="true" data-bs-backdrop="static">
			<div class="modal-dialog" style="max-width: 800px;">
				<div class="modal-content">
					<div class="modal-header">
		...
		<div class="modal fade" id="modalEditarInfoComentario" data-bs-backdrop="static"  tabindex="-1" aria-labelledby="modalEditarInfoComentarioLabel" aria-hidden="true" data-bs-backdrop="static">
			<div class="modal-dialog" style="max-width: 800px;">
				<div class="modal-content">
					<div class="modal-header">
