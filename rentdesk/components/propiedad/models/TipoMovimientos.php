...
$query_count = "SELECT * from propiedades.tp_tipo_movimiento_cta_cte where id_responsable in (1, 3) AND id_tipo_movimiento = 1 AND visible = true";

$data = array("consulta" => $query_count);
$resultado = $services->sendPostNoToken($url_services . '/util/objeto', $data);

// Devolver el JSON ordenado
echo $resultado;
