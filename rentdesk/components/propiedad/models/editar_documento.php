...
if ($fis_arch!="") {
				...
				$doc_ima_fisico =  $nombre_sin_extension."___-___propiedad_".$nombre_archivo;
				move_uploaded_file($_FILES["archivoEditar"]["tmp_name"], "../../../upload/propiedad/" . $doc_ima_fisico.".". pathinfo($fis_arch, PATHINFO_EXTENSION));
