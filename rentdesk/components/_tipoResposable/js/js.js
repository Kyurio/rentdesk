...
var formData = new FormData(document.getElementById("formulario"));
   ...
   $.ajax({
                url: "components/tipoResposable/models/insert_update.php",
                type: "post",
                dataType: "html",
                data: formData,
                cache: false,
             ...
             .done(function(res){
				...
				if (resultado == 'OK'){
					...
					document.location.href="index.php?component=tipoResposable&view=tipoResposable&token="+token;
					return false;
...
$(document).ready(function() { 
  ...
  $('#tabla').DataTable( {
	   "order": [[ 2, "asc" ]],
        ...
        "ajax": {
			"url":"components/tipoResposable/models/tipoResposable_list_procesa.php",
		"type": "POST"},
		"language": {
...
//************************************************************************
function deleteTipo_responsable(token){
	...
	onSubmit: function (result) {
		if(result) {
				  $.ajax({
					  type: 'POST',
					  url: "components/tipoResposable/models/delete.php",
					  data:  "token="+token,
