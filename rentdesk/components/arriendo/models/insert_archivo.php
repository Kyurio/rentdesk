	...
	//	var_dump($tipo_archivo);
		...
		///if (isset($fechasDocumento[$indice])) { //Se comenta por que puede ser que no venga una fecha
         ...
         //       var_dump("Archivo", $nombre_sin_extension, "Fecha de Documento", $fechaDocumento);
				...
				move_uploaded_file($archivo["tmp_name"], "../../../upload/arriendo/" . $doc_ima_fisico.".".$extension);
				//move_uploaded_file($_FILES["archivo"]["tmp_name"], "../../../upload/arriendo/" . $doc_ima_fisico.".".$tipo_archivo);
                    ...
                    (id, id_usuario, fecha_subida, ruta, componente, archivo, titulo, fecha_vencimiento, id_ficha_arriendo, estado,extension,token_agrupador,nombre_archivo)
                     VALUES(nextval('propiedades.propiedad_archivos_id_seq'::regclass),$objUsuarioId->id, '$fecha','$carpeta' ,'arriendo', '$doc_ima_fisico' , '$documentoTitulo', '$fechaDocumento', $objArriendoId->id,true,'$extension','$token_agrupador','$nombre_sin_extension') ";
