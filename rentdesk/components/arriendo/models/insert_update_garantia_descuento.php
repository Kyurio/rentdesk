...
$modalGarantiaRazon = $_POST['razonDescuento'];
$modalMontoGarantia = $_POST['montoDescuento'];
$modalMonedaGarantia = $_POST['monedaDescuento'];
$modalGarantiaPagado = $_POST['pagadoDescuento'];
$modalGarantiaFecha = $_POST['fechaDescuento'];
...
if ($doc_ima_fisico) {
	...
	$query = "INSERT INTO propiedades.garantia_movimientos (id_arriendo, id_propiedad, fecha_movimiento, razon, monto, moneda, archivo, estado, token)
	VALUES('$id_arriendo','$id_propiedad','$hoy','$modalGarantiaRazon','$modalMontoGarantia', '$modalMonedaGarantia','$doc_ima_fisico', '$estado', '$token_nuevo', 1)";
} else {

	$query = "INSERT INTO propiedades.garantia_movimientos (id_arriendo, id_propiedad, fecha_movimiento, razon, monto, moneda, estado, token)
	VALUES('$id_arriendo','$id_propiedad','$hoy','$modalGarantiaRazon','$modalMontoGarantia', '$modalMonedaGarantia', '$estado', '$token_nuevo', 1)";
}
$data = array("consulta" => $query);
