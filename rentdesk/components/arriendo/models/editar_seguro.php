...
$servicioSeguroNotificacionEditar = @$_POST['servicioSeguroNotificacionEditar'];



$config= str_replace(",", "", $montoEditar);
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	$queryCabecera= " UPDATE propiedades.ficha_arriendo_servicios
					...
					fecha_modificacion='$fecha', notificacion_seguro = '$servicioSeguroNotificacionEditar'
