 ...
 <div id="header" class="header-page">
 	...
 	<div style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
 		<ol class="breadcrumb d-flex align-items-center m-0">
 			...
 			<li class="breadcrumb-item" style="color: #e62238" aria-current="page"><a href="index.php?component=arrendatario&view=arrendatario_list" style="text-decoration: none;color:#66615b">Arrendatarios</a></li>
 			<li class="breadcrumb-item active" style="font-weight:600;color: #e62238" aria-current="page">Arrendatario</li>
 		</ol>
 	</div>
 </div>
 	...
 	<div class="row g-3">
 		<fieldset class="form-group border p-3">
 			...
 			<fieldset class="form-group border p-3" id="section-info-cliente-natural" style="display: none">
 				...
 				<div class="row">
 					<div class="col"><b>Nombre</label><br> <label id="nombrePersona"></label></b></div>
 					<div class="col"><b>Telefono</label><br> <label id="telefonoMovilPersona"></label></b></div>
 					<div class="col"><b>Email </label><br> <label id="emailPersona"></label></b></div>
 					<div class="col"><b>Tipo Persona</label><br> <label id="tipoPersona"></label></b></div>

 				</div>
 				<div class="row" style="margin-top: 10px">
 					<div class="col">
						<b><label>Direccion</label><br> <label id="direccionPersona"></label></b>
 		...
 		<?php } else { ?>
 							...
 							<div class="row g-3">
 								<div class="col-lg-4">
 									<div class="form-group">
 										...
 										<input type="text" class="form-control" maxlength="100" name="nombreTitular" id="nombreTitular" placeholder="Nombre Titular" value="" onBlur="elimina_slash(this);elimina_comillas(this);elimina_blancos_inicio_fin(this);">
 									</div>
 								</div>
 								<div class="col-lg-4">
 									<div class="form-group">
 										<label><span class="obligatorio"></span> RUT</label>
 										<input type="text" oninput="checkRut(this);" class="form-control" maxlength="100" name="rutTitular" id="rutTitular" placeholder="Rut" value="" onBlur="elimina_slash(this);elimina_comillas(this);elimina_blancos_inicio_fin(this);">
 									</div>
 								</div>
 								...
 								<div class="col-lg-4">
 									<div class="form-group">
 										...
 										<input type="email" class="form-control" maxlength="100" name="emailTitular" id="emailTitular" placeholder="Email Titular" value="" onBlur="elimina_slash(this);elimina_comillas(this);elimina_blancos_inicio_fin(this);">
 									</div>
 								</div>
 								...
 								<div class="col-lg-4">
 									<div class="form-group">
 										...
 										<input type="text" class="form-control" maxlength="100" name="numCuenta" id="numCuenta" placeholder="Número Cuenta" value="" onBlur="elimina_slash(this);elimina_comillas(this);elimina_blancos_inicio_fin(this);">
 									</div>
 								</div>
 							</div>
 							<?php if (isset($token)) { ?>
 										...
 										<td>
 											<div class="d-flex" style="gap: .5rem;">
 												<a data-bs-toggle="modal"
 													onclick="cargarCuenta('<?php echo $resultado->id_banco ?>','<?php echo $resultado->rut_titular ?>','<?php echo $resultado->nombre_titular ?>','<?php echo $resultado->correo_electronico ?>','<?php echo $resultado->id ?>','<?php echo $resultado->id_tipo_cuenta ?>','<?php echo $resultado->numero ?>')"
 													data-bs-target="#modalChequesEditarLabel" type="button" class="btn btn-info m-0 d-flex" style="padding: .5rem;" aria-label="Editar" title="Editar">
 													...
 													<form name="cuenta_formulario_Editar" id="cuenta_formulario_Editar" method="post" enctype="multipart/form-data" class="my-3">
 														<div class="row">
 															<div class="col mb-3">
 																...
 																<input type="text" class="form-control" maxlength="100" name="nombreTitularEdit" id="nombreTitularEdit" placeholder="Nombre Titular" data-validation-required="" value="" onblur="elimina_slash(this);elimina_comillas(this);elimina_blancos_inicio_fin(this);" form='form22'>
 															</div>

 															<div class="col mb-3">
 																<label for="rutTitularEdit" class="form-label"><span class="obligatorio">*</span> RUT</label>
 																<input type="text" oninput="checkRut(this);" class="form-control" maxlength="100" name="rutTitularEdit" id="rutTitularEdit" placeholder="Rut" data-validation-required="" value="" onblur="elimina_slash(this);elimina_comillas(this);elimina_blancos_inicio_fin(this);" form='form22'>
 															</div>
 														</div>
 														<div class="row">
 															<div class="col mb-3">
 																<label for="emailTitularEdit" class="form-label"><span class="obligatorio">*</span>Email Titular</label>
 																<input type="email" class="form-control" maxlength="100" name="emailTitularEdit" id="emailTitularEdit" placeholder="Email Titular" data-validation-required="" value="" onblur="elimina_slash(this);elimina_comillas(this);elimina_blancos_inicio_fin(this);" form='form22'>
 															</div>
 															<div class="col mb-3">
 														...
 														<div class="row">
 															...
 															<div class="col mb-3">
 																...
 																<input type="text" class="form-control" maxlength="100" name="numCuentaEdit" id="numCuentaEdit" placeholder="Número Cuenta" data-validation-required="" value="" onblur="elimina_slash(this);elimina_comillas(this);elimina_blancos_inicio_fin(this);" form='form22'>
 															</div>
 														</div>
 			...
 			<div class="row g-3">
 				<div class="col-lg-12 text-center">
 					<a href="index.php?component=arrendatario&view=arrendatario_list">
 					...
 					<?php } else {
						?>
 						<button type="submit" id="buttonSave" style="display: none" class="btn btn-danger"> Aceptar </button>
