...
$cantidad_filtrados++;
	 ...
	 $tabla =  "<table   border='0' cellspacing='0' cellpadding='1'>
		<tr>
		<td colspan='14' style='background-color:#C0C0C0;  color: #000000; border: 1px solid #363636; font-family:Arial; font-size:14px; text-align:center;'> Excel Arrendatario </td>
		</tr>
		<tr>
...
$ruta = "../../../upload/arrendatario/excel/excel_arrendatario_".$aleatorio.".xls";
