...
$cantidad_filtrados++;
		...
		$botones =  "<a href='index.php?component=arrendatario&view=arrendatario&token=$obj->tokencodeudor' type='button' class='btn btn-info m-0' style='padding: .5rem;' aria-label='Editar' title='Editar'> <i class='fa-regular fa-pen-to-square' style='font-size: .75rem;'></i></a>";
 ...
 $tabla =  "<table   border='0' cellspacing='0' cellpadding='1'>
		<tr>
		<td colspan='14' style='background-color:#C0C0C0;  color: #000000; border: 1px solid #363636; font-family:Arial; font-size:14px; text-align:center;'> Excel Codeudor </td>
		</tr>
		<tr>
...
$ruta = "../../../upload/codeudor/excel/excel_codeudor_".$aleatorio.".xls";
