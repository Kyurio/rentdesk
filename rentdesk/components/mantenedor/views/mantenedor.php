	...
	<form name="formulario" id="formulario" method="post" action="javascript: enviarRentdesk();" enctype="multipart/form-data" class="my-3">
		<div class="row g-3">
			...
			<h5 class="mt-0">Detalles</h5>
						...
						<div class="col-md">
                            <div class="form-group">
                             ...
                             <!--   <input type="text" class="form-control" id="filtro_codigo_propiedad" name="filtro_codigo_propiedad" value="" placeholder="Ingrese Código">  -->
								<input type="text" id="codigo_propiedad" value="" name="codigo_propiedad" class="form-control" placeholder="Cód.Propiedad o Dirección o Nro Contrato"  onblur="ocultarAutocomplete('codigo_propiedad');" autocomplete='off' onkeyup='buscarPropiedadAutocomplete(this.value,"codigo_propiedad");'><div id='suggestions_codigo_propiedad'></div>
                            </div>
                        </div>
					</div>
					<div class="col-md">
				...
				<button type="button" class="btn btn-danger" class="btn btn-danger" onclick="creaArriendo();"> Continuar formulario </button>
