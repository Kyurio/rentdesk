    ...
    <div>
        ...
        <div style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb d-flex align-items-center m-0">
                ...
                <li class="breadcrumb-item active" style="font-weight:600;color: #e62238" aria-current="page">Facturas - Generación Masiva Automática</li>
            </ol>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-body ">
            ...
            <div class="table-responsive overflow-auto">
                <table id="propietario-facturas-gen-masiva-table" class="table table-striped" cellspacing="0" width="100%">

                    <thead>
                        <tr>
                            <th class="col-2">Nro. Liquidación</th>
                            <th class="col-1">Propiedad</th>
                            <th class="col-1">Monto</th>
                            <th class="col-1">Co-Propietarios</th>
