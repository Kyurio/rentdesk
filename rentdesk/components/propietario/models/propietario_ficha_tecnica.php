...
$dataTableCuentaCorriente = array(
	array("13/02/2024 11:10:00", "AMERICO VESPUCIO 7301 Departamento 31 PLAN SILVER+SEGURO", "Comisión: pagos recibidos al 13/02/2024 + IVA", "-", "$6.664", "-$1.827"),
	array("13/02/2024 11:10:00", "AMERICO VESPUCIO 7301 Departamento 31 PLAN SILVER+SEGURO", "Arriendo: pagos recibidos al 13/02/2024", "$140.000", "-", "$4.837"),
	array("07/02/2024 11:23:15", "AMERICO VESPUCIO 7301 Departamento 31 PLAN SILVER+SEGURO", "Comisión: pagos recibidos al 07/02/2024 + IVA", "-", "$10.948", "	-$135.163"),
	array("07/02/2024 11:23:15", "AMERICO VESPUCIO 7301 Departamento 31 PLAN SILVER+SEGURO", "Arriendo: pagos recibidos al 07/02/2024", "$230.000", "-", "-$124.215"),
	array("06/02/2024 11:12:23", "AMERICO VESPUCIO 7301 Departamento 31 PLAN SILVER+SEGURO", "Renta Anticipada Febrero 2024", "-", "$179.620", "-$354.215"),
...
$dataTableLiquidacionesActuales = array(
	array("271512", "AMERICO VESPUCIO 7301 Departamento 31 PLAN SILVER+SEGURO, La Florida, Región Metropolitana", "$376.824", "$376.824", "$9.200", "$1.748", "$0", "$354.215", "-$135.163"),
	array("273737", "AMERICO VESPUCIO 7301 Departamento 31 PLAN SILVER+SEGURO, La Florida, Región Metropolitana", "$376.824", "$140.000", "$5.600", "$1.064", "$0", "$0", "-$1.827"),
...
$dataTableLiquidacionesAntiguas = array(
	array("263364", "09/01/2024", "AMERICO VESPUCIO 7301 Departamento 31 PLAN SILVER+SEGURO, La Florida, Región Metropolitana", "$376.824", "$380.000", "$15.200", "$2.888", "$0", "$346.000", "$15.912"),
);
...
/**********************Info tecnica Propietario******************************* */
$queryPropietario = " SELECT ps.dni as dni, ps.token as token, ps.id_tipo_persona as id_tipo_persona ,
  ...
  pd.direccion as direccion, pd.numero, pp.id_persona  as id_porpietario,
  ...
  pp.token as tokenpropietario, ttd.nombre  as tipo_dni
  ...
  $dataPropietario = array("consulta" => $queryPropietario );	
  $resultadoPropietario = $services->sendPostDirecto($url_services.'/util/objeto',$dataPropietario);
  $result_jsonPropietario = json_decode($resultadoPropietario);


  if($result_jsonPropietario){

		$tipo_persona = $result_jsonPropietario[0]->tipo_persona;
		if($result_jsonPropietario[0]->tipo_persona == "NATURAL"){
			$nombre= @$result_jsonPropietario[0]->nombres.' '.$result_jsonPropietario[0]->apellido_paterno.' '.$result_jsonPropietario[0]->apellido_materno;
		}
		if($result_jsonPropietario[0]->tipo_persona == "JURIDICA"){
			$nombre = @$result_jsonPropietario[0]->razon_social;
		}
		$tipo_dni = $result_jsonPropietario[0]->tipo_dni;
		$dni = $result_jsonPropietario[0]->dni;
		$correo_electronico = $result_jsonPropietario[0]->correo_electronico;
		$telefono_fijo = $result_jsonPropietario[0]->telefono_fijo;
		$telefono_movil = $result_jsonPropietario[0]->telefono_movil;
		$direccion = $result_jsonPropietario[0]->direccion.", ".$result_jsonPropietario[0]->region.", ".$result_jsonPropietario[0]->pais;
		$nombre_fantasia = $result_jsonPropietario[0]->nombre_fantasia;
	
}

/**********************Info Propiedades Propietario******************************* */



$query_propiedades = " select p.id, p.direccion, p.codigo_propiedad from propiedades.propiedad p 
 ...
 where vp.token_propietario = '896d8779f1783429a2ab34f1984aba9e'";
 ...
 $result_propiedades = json_decode($resultado_propiedades);

//print_r($result_propiedades);
?>
