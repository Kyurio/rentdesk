...
if (isset($_SESSION['sesion_rd_sucursales'])) {
    ...
    if (isset($_POST['sucursal'])) {
        $_SESSION['rd_current_sucursal'] = serialize(json_decode($_POST['sucursal']));
        // var_dump("SUCURSAL SELECCIONADA: ", $_SESSION['rd_current_sucursal']);

        /*LLAMADO A ENDPOINT SUCURSALES */
        $current_sucursal = json_decode($_POST['sucursal']);
