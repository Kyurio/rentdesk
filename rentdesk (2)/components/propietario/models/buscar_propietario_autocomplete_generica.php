...
$queryProp = " SELECT ps.dni as dni, ps.token as token, ps.id_tipo_persona as id_tipo_persona ,
  ...
  where pp.id_persona is not null and ps.id_subsidiaria = $id_subsidiaria and (
...
// Consulta optimizada
$queryProp = "SELECT dni, nombre_1 AS nombre, nombre_2 AS apellido_paterno, nombre_3 AS apellido_materno from propiedades.vis_propietarios WHERE 
