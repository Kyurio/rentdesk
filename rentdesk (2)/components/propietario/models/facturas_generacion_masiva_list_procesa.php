...
$objPropietarioFacturacionGenMasiva = json_decode($resultado);


// echo json_encode($objPropietarioFacturacionGenMasiva);
...
if ($cantidad_registros  != 0) {
    ...
    foreach ($objPropietarioFacturacionGenMasiva as $result) {
        if ($coma == 1)
            $signo_coma = ",";
        ...
        $nro_liquidacion = $result->nro_liquidacion;
