...
(id_propiedad, id_ficha_arriendo, fecha_movimiento, hora_movimiento, id_tipo_movimiento_cta_cte, monto, razon, cobro_comision)
 VALUES ($objIdArriendo->id_propiedad, $objIdArriendo->id,'$ccFecha', '$time', 3, $ccMonto,'$ccRazon', $ccCobraComision)";

var_dump($queryInsertCcPago);

$dataCab = array("consulta" => $queryInsertCcPago);
$resultadoCab = $services->sendPostDirecto($url_services . '/util/dml', $dataCab);

echo  "Descuento Autorizado Guardado";

// $queryInsertCcPagoRef = "SELECT propiedades.fn_inserta_tipo_mov_pago('FICHA_ARRIENDO',$objIdArriendo->id, 3)";
