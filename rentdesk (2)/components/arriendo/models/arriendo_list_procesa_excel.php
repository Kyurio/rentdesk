...
$cantidad_registros =$resultado;
	...
	$dataTableArriendoActivos = [];
		...
		$lista = $lista. "
		<tr>
		<td style='background-color:$fondo;  color: #000000; border: 1px solid #363636; font-family:Arial; font-size:12px;'>$ficha_arriendo</td>
		<td style='background-color:$fondo;  color: #000000; border: 1px solid #363636; font-family:Arial; font-size:12px;'>$obj->propiedad</td>
		...
		<td style='background-color:$fondo;  color: #000000; border: 1px solid #363636; font-family:Arial; font-size:12px;'>$json_estado_contrato->estado_contrato</td>
		...
		<td style='background-color:$fondo;  color: #000000; border: 1px solid #363636; font-family:Arial; font-size:12px;'>$obj->nombre_arrendador</td>
		<td style='background-color:$fondo;  color: #000000; border: 1px solid #363636; font-family:Arial; font-size:12px;'>$obj->fecha_ingreso</td>
		<td style='background-color:$fondo;  color: #000000; border: 1px solid #363636; font-family:Arial; font-size:12px;'>$montoFomateado</td>
		</tr>
		";	
				}
			}
...
$tabla =  "<table   border='0' cellspacing='0' cellpadding='1'>
		<tr>
		<td colspan='14' style='background-color:#C0C0C0;  color: #000000; border: 1px solid #363636; font-family:Arial; font-size:14px; text-align:center;'> Excel Arriendos </td>
		</tr>
		<tr>
...
$ruta = "../../../upload/arriendo/excel/excel_arriendo_".$aleatorio.".xls";
