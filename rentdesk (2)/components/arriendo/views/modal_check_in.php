...
<body class="">
	...
	<script>loadCheckIn('<?php echo @$token_propiedad;?>');</script>
<h2>Seleccione el Check-In</h2>           

       <div class="herramientas">
       <button type="button" class="btn btn-info btn-sm" onClick="javascript: document.location.reload();">
