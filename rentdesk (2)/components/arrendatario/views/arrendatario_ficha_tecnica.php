...
<div id="header" class="header-page">
	...
	<div style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
		<ol class="breadcrumb d-flex align-items-center m-0">
			...
			<li class="breadcrumb-item active" style="font-weight:600;color: #e62238" aria-current="page">Arrendatario SOC. DE INVERSIONES URBANO LTDA.</li>
		</ol>
	</div>
</div>
	...
	<div class="row">
		<div class="col-lg-2 p-0 " style="display:none;">
			...
			<ul class="nav flex-column nav-pills p-0" id="myTab" role="tablist" aria-orientation="vertical" style="display: flex;gap:1rem">
				...
				<li class="nav-item" role="presentation">
					<button class="d-flex nav-link active w-100" id="arrendatario-ft-informacion-tab" data-bs-toggle="tab" data-bs-target="#informacion" type="button" role="tab" aria-controls="informacion" aria-selected="true">Información</button>
				</li>

				<li class="nav-item" role="presentation">
					<button class="d-flex nav-link w-100" id="arrendatario-ft-cuentaCorriente-tab" data-bs-toggle="tab" data-bs-target="#cuentaCorriente" type="button" role="tab" aria-controls="cuentaCorriente" aria-selected="false">Cuenta Corriente</button>
				</li>

				<li class="nav-item" role="presentation">
					<button class="d-flex nav-link w-100" id="arrendatario-ft-arriendos-tab" data-bs-toggle="tab" data-bs-target="#arriendos" type="button" role="tab" aria-controls="arriendos" aria-selected="false">Arriendos</button>
				</li>

				<li class="nav-item" role="presentation">
					<button class="d-flex nav-link w-100" id="arrendatario-ft-historial-tab" data-bs-toggle="tab" data-bs-target="#historial" type="button" role="tab" aria-controls="historial" aria-selected="false">Historial</button>
				</li>
		...
		<div class="col-lg-12">
			...
			<div class="tab-content">
				...
				<div class="tab-pane active" id="informacion" role="tabpanel" aria-labelledby="arrendatario-ft-informacion-tab" tabindex="0">
							...
							<div class="card-body">
								...
								<div class="row">
									<div class="col-md-6">
										<dl>
											<dt>Nombre</dt>
											<dd>SOC. DE INVERSIONES URBANO LTDA.</dd>
				...
				<div class="tab-pane" id="cuentaCorriente" role="tabpanel" aria-labelledby="arrendatario-ft-cuentaCorriente-tab" tabindex="0">
					<div class="container-fluid">
									...
									<div class="card">
										<div class="card-body">
											<div class="table-responsive overflow-auto">
												...
												<table id="cuentaCorriente" class="table table-striped" cellspacing="0" width="100%">
													<thead>
														<tr>
															<th>Fecha</th>
															<th>Procedencia</th>
															...
															<tr>
																<?php foreach ($row as $key => $cell) : ?>
																	...
																	<?php if (in_array($key, [1]) && (isset($cell) && $cell !== "-")) : ?>
																		<td><a href="index.php?component=arriendo&view=arriendo_ficha_tecnica" class="link-info"><?php echo $cell; ?></a></td>
				...
				<div class="tab-pane" id="arriendos" role="tabpanel" aria-labelledby="arrendatario-ft-arriendos-tab" tabindex="0">
					<div class="container-fluid">
														...
														<?php foreach ($dataTableArriendos as $row) : ?>
															<tr>
																<?php foreach ($row as $key => $cell) : ?>
																	...
																	<?php if (in_array($key, [0]) && (isset($cell) && $cell !== "-")) : ?>
																		<td><a href="index.php?component=arriendo&view=arriendo_ficha_tecnica" class="link-info"><?php echo $cell; ?></a></td>

																	<?php elseif (in_array($key, [1]) && (isset($cell) && $cell !== "-")) : ?>
				...
				<div class="tab-pane" id="historial" role="tabpanel" aria-labelledby="arrendatario-ft-historial-tab" tabindex="0">
					<div class="container-fluid">
									...
									<div class="card">
										<div class="card-body">
											<div class="table-responsive overflow-auto">
												...
												<table id="historial" class="table table-striped" cellspacing="0" width="100%">
													<thead>
														<tr>
															<th>Fecha</th>
															<th>Responsable</th>
