...
$sucursalMatriz = @$_GET["activo"];

var_dump("Matriz: ",$sucursalMatriz); 
$ID_sbs_Editar= @$_GET["id"];
...
$querySucursal = "UPDATE propiedades.cuenta_subsidiaria SET  activo = false , habilitada = false
