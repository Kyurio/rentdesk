				...
				<div class="row">		
					...
					<div class="col-md-3">		
                        ...
                        <label >Propietario:</label>
                            <input type="text" class="form-control" maxlength="250" name="propietario" id="propietario" readonly value="<?php echo @$propietario?>"  >
                        </div>
					</div>	
					<div class="col-md-3">		
						<div class="form-group">
                        <label >Participación:</label>
                            <input type="text" class="form-control" maxlength="250" name="propietario" id="propietario" readonly value="<?php echo @$result->porcentaje?>"  >
                        </div>
					</div>	
				</div>
				<div class="row">	
					...
					<div class="col-md-3">		
                       <div class="form-group">
                        <label >Fecha Vencimiento:</label>
                            <input type="text" class="form-control" maxlength="250" name="fecha_vencimiento" id="fecha_vencimiento" readonly value="<?php echo @$result->fecha_vencimiento;?>"  >
                        </div>
				...
				<div class="row"> 
					...
					<div class="col-md-12">
						...
						<div class="col-md-12 text-left">
							<?php echo $lista_items_liquidacion;?>
						</div>
					</div>	
				</div>
