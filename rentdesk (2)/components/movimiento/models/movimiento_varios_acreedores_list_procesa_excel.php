	...
	$tipo_voucher = "Descuento VA";
	 ...
	 [
	  ...
	  \"$obj->valor\"
			...
			$lista = $lista. "
		<tr>
		<td style='background-color:$fondo;  color: #000000; border: 1px solid #363636; font-family:Arial; font-size:12px;'>$obj->id_vou_cierre</td>
		<td style='background-color:$fondo;  color: #000000; border: 1px solid #363636; font-family:Arial; font-size:12px;'>$fecha_formateada</td>
		...
		<td style='background-color:$fondo;  color: #000000; border: 1px solid #363636; font-family:Arial; font-size:12px;'>$tipo_voucher</td>
		<td style='background-color:$fondo;  color: #000000; border: 1px solid #363636; font-family:Arial; font-size:12px;'>$obj->razon</td>
		<td style='background-color:$fondo;  color: #000000; border: 1px solid #363636; font-family:Arial; font-size:12px;'>$obj->valor</td>
		</tr ";
...
//************************************************************************************************************
 ...
 $tabla =  "<table   border='0' cellspacing='0' cellpadding='1'>
		...
		<tr>
		<td style='background-color:#1f268e; color: #ffffff; border: 1px solid #363636; font-family:Arial; font-size:12px; padding:4px;'>Id cierre</td>
		<td style='background-color:#1f268e; color: #ffffff; border: 1px solid #363636; font-family:Arial; font-size:12px; padding:4px;'>Fecha</td>
		<td style='background-color:#1f268e; color: #ffffff; border: 1px solid #363636; font-family:Arial; font-size:12px; padding:4px;'>Propiedad</td>
		<td style='background-color:#1f268e; color: #ffffff; border: 1px solid #363636; font-family:Arial; font-size:12px; padding:4px;'>Propietario/Beneficiario</td>
		<td style='background-color:#1f268e; color: #ffffff; border: 1px solid #363636; font-family:Arial; font-size:12px; padding:4px;'>Tipo</td>
		<td style='background-color:#1f268e; color: #ffffff; border: 1px solid #363636; font-family:Arial; font-size:12px; padding:4px;'>Rázon</td>
		<td style='background-color:#1f268e; color: #ffffff; border: 1px solid #363636; font-family:Arial; font-size:12px; padding:4px;'>Monto</td>
		</tr>
 ...
 $lista
	  ...
	  $excel = "
		...
		<head>
		<meta charset='utf-8'>
		<title>Movimientos - Varios Acreedores </title>
		</head>
		<body>
			$tabla
		</body>
...
$ruta = "../../../upload/movimiento/excel/excel_movimientos_".$aleatorio.".xls";
