...
$ver = "";
$ver = "<a href='index.php?component=user&view=user&token=$result->token'><i class='fas fa-search'></i></a>";

$eliminar = "";
$eliminar = "<a href='javascript: deleteUser(\\\"$result->token\\\");'><i class='far fa-trash-alt'></i></a>"; 
